...
import jabs from "./skillsImages/Puncturing_Sweep.png"
...
import wall from "./skillsImages/Unstable_Wall_of_Fire.png"
...
function Magplar() {
  return (
    <div className='display-class'>
        <h2>Magicka Templar</h2>
        
        <div className='intro'>
            <h3>Introduction</h3>
            <p>
              The Magicka Templar is a good class for multi-target fights. It excels, especially in solo content or 4-player dungeons. Its spell kit consists of many area-of-effect damages, favoring this aspect.
            </p>
        </div>
        ...
        <div className='builds'>
            ...
            <div className='build-1'>
                ...
                <div className='skills'>
                    ...
                    <div className='bar-1'>
                        ...
                        <img src={jabs} alt="puncturing sweeps"/>
            ...
            <div className='build-2'>
                ...
                <div className='skills'>
                    ...
                    <div className='bar-2'>
                        <img src={wall} alt="unstable wall of fire"/>
